  ...
  final result = await showDialog<(String, String?)>(
    ...
    builder: (dialogContext) => StatefulBuilder(
      builder: (context, setState) => AlertDialog(
        title: Text(item == null ? 'Nuovo elemento' : 'Modifica elemento'),
        content: Column(
                    ...
                    ...imported.map((item) {
                      ...
                      return SurfaceCard(
                        child: CheckboxListTile(
                          ...
                          title: Text(item.nome),
                          subtitle: Text(
                            'Da lista condivisa: ${item.chiPorta}',
                          ),
                          onChanged: (value) {
